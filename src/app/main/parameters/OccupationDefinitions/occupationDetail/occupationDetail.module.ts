...
import { OccupationDetailComponent } from "./occupationDetail.component";
...
const routes = [
    {
        path: "occupationDefinitions/:id",
        component: OccupationDetailComponent,
        resolve: {
            data: OccupationDetailService,
        },
    },
];
...
@NgModule({
    ...
    providers: [
        ...
        AddAlertOccupation,
        UpdateAlertOccupation,
    ],
})
export class OccupationDetailModule {}
