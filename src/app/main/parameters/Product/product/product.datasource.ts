...
export class ProductDataSource extends DataSource<any> {
    ...
    constructor(
        ...
        super();
        this.filteredData = this.productService.productModuleList;
    }
    ...
    connect(): Observable<any[]> {
        ...
        return merge(...displayDataChanges).pipe(
            map(() => {
                if (this.productService.productModuleList === undefined) {
                    return;
                }
                if (this.productService.productModuleList === undefined) {
                    return;
                }
                let data = this.productService.productModuleList.slice();
