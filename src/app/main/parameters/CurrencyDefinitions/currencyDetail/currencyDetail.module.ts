...
import { CurrencyDetailComponent } from "./currencyDetail.component";
...
@NgModule({
    ...
    providers: [CurrencyDetailService, AddAlertCurrency, UpdateAlertCurrency],
})
