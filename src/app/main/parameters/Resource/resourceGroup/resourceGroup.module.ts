...
const routes = [
    {
        ...
        resolve: {
            data: ResourceGroupService,
            data2: ResourceGroupsService,
        },
    },
];

@NgModule({
    declarations: [ResourceGroupComponent, ResourceGroupFormDialogComponent],
    imports: [
    ...
    providers: [
        ...
        AddAlertResourceGroup,
        UpdateAlertResourceGroup,
    ],
    entryComponents: [ResourceGroupFormDialogComponent],
})
