...
@NgModule({
    declarations: [CountyComponent, CountyFormDialogComponent],
    imports: [
    ...
    providers: [CountyService, AddAlertCounty, UpdateAlertCounty],
    entryComponents: [CountyFormDialogComponent],
})
