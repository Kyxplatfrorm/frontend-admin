...
export class TenantCountryDataSource extends DataSource<any> {
    ...
    constructor(
        ...
        super();
        this.filteredData =
            this.tenantCountryService.tenantApiResponse.TenantDefinitionList;
    }

    connect(): Observable<any[]> {
        const displayDataChanges = [
            this.tenantCountryService.onTenantChanged,
        ...
        return merge(...displayDataChanges).pipe(
            map(() => {
                let data =
                    this.tenantCountryService.tenantApiResponse.TenantDefinitionList.slice();
...
export default TenantCountryDataSource;
