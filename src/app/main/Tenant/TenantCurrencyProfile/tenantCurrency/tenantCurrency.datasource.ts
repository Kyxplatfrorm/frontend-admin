...
export class TenantCurrencyDataSource extends DataSource<any> {
    ...
    constructor(
        ...
        super();
        this.filteredData =
            this.tenantCurrencyService.tenantApiResponse.TenantDefinitionList;
    }

    connect(): Observable<any[]> {
        const displayDataChanges = [
            this.tenantCurrencyService.onTenantChanged,
        ...
        return merge(...displayDataChanges).pipe(
            map(() => {
                let data =
                    this.tenantCurrencyService.tenantApiResponse.TenantDefinitionList.slice();
...
export default TenantCurrencyDataSource;
