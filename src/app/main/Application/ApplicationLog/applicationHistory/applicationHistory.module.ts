...
import { ApplicationLogHistoryComponent } from "./applicationHistory.component";
...
const routes = [
    {
        ...
        resolve: {
            data: ApplicationLogService,
            data2: ApplicationLogHistoryService,
        },
    },
];

@NgModule({
    declarations: [ApplicationLogHistoryComponent],
    imports: [
    ...
    providers: [ApplicationLogService, ApplicationLogHistoryService],
})
