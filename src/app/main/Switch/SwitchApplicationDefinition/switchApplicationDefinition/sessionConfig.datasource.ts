...
export class SessionConfigDataSource extends DataSource<any> {
    ...
    connect(): Observable<any[]> {
        ...
        return merge(...displayDataChanges).pipe(
            map(() => {
                ...
                let data =
                    this.switchApplicationDefinitionService.sessionConfigList.slice();
...
export default SessionConfigDataSource;
