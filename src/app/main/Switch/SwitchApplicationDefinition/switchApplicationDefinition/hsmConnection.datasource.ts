...
export class HsmConnectionDataSource extends DataSource<any> {
    ...
    connect(): Observable<any[]> {
        ...
        return merge(...displayDataChanges).pipe(
            map(() => {
                ...
                let data =
                    this.switchApplicationDefinitionService.hsmConnectionList.slice();
...
export default HsmConnectionDataSource;
